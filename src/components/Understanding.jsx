        ...
        <>
            <section className=' under-bg position-relative'>
                ...
                <div className=' container position-relative z-1'>
                    <h3 className=' mb-0 white ff-cond fw-700 text-48 lh-57 text-center pt-4 pt-sm-0'>Understanding Dry Ice Blasting</h3>
                    <div className="row py-under-1 ">
                        ...
                        <div className="col-lg-6 d-flex justify-content-center justify-content-lg-end d-xxl-none mt-4 mt-md-0">
