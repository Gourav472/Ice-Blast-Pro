            ...
            <section className=' position-relative'>
                <div className=' container position-relative z-2 '>
                    <div className="row flex-column-reverse flex-lg-row py-team">
                        <div className="col-12 col-lg-5 mt-team-col d-flex justify-content-center justify-content-xl-end  position-relative  ">
                        ...
                        <div className="col-12 col-lg-7  d-flex justify-content-center align-items-lg-center justify-content-lg-end justify-content-xxl-center">
