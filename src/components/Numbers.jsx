            ...
            <section className=' py-numbers' id='price'>
                <div className=' container'>
                    <div className=' d-flex flex-column align-items-center'>
                        <h3 className=' mb-0 black fw-700 ff-cond text-48 lh-57 pt-numbers'>Let's Talk Numbers</h3>
                        <p className=' mb-0 max-759 ff-acumin fw-400 text-16 lh-lh-24 text-center op-70 pt-14'>We're all about transparency, but we also know that each car tells a different story. The cost can vary based on how much grime we're up against. More dirt might mean more ice and more time to get that perfect finish. But don't sweat it – we'll always give you a straight price, customised to your car's needs.</p>

                        <div className="py-accordian accordions d-flex flex-column gap-20 w-100">
                        ...
                        <div className=' w-100 instant-box d-flex flex-column align-items-center'>
