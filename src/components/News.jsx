            ...
            <section>
                <div className=' container'>
                    <div className=' d-flex flex-column'>
                        <h3 className=' mb-0 black text-center ff-cond fw-700 text-48 lh-57 pt-3 pt-md-0'>Latest News & Insights</h3>
                        <p className=' mb-0 black op-70 ff-acumin fw-400 text-16 lh-24 pt-3 text-center'>Uncover the latest insights and innovation in car care.</p>
                        <div className="row py-news-row">
                            ...
                            <div className="col-12 col-md-6 col-lg-4 d-flex justify-content-center  mt-4 mt-lg-0 ">
                                <div className='news-box d-flex flex-column w-100 cp'>
                            ...
                            <div className="col-12 col-lg-4 d-flex justify-content-center justify-content-lg-end mt-4 mt-lg-0">
                                <div className='news-box d-flex flex-column w-100 cp'>
                    ...
                    <div className=' d-flex justify-content-center pb-news'>
